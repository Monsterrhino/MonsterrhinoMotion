...
class MyApp:
    def __init__(self):
        ...
        self.load_img = Button(self.myContainer1, text="Set start pos!", command=self.set_start_pos, bg='black', fg="white", activebackground=HOVERCOLER, borderwidth=2,
                                      highlightbackground="black", font="none 18")
        ...
        self.burn = Button(self.myContainer1, text="Start slide!", command=self.start_sliding, bg='black', fg="white", activebackground=HOVERCOLER, borderwidth=2,
                                      highlightbackground="black", font="none 18")
        ...
        self.xdir_label = Label(self.myContainer1, text="y_max = 1500 steps ------------> y", bg='black', fg="white", activebackground=HOVERCOLER, borderwidth=2,
                                      highlightbackground="black", font="none 8")
        self.rotate_img = Button(self.myContainer1, text="Rotate Table!",  command=self.start_table, bg='black', fg="white", activebackground=HOVERCOLER, borderwidth=2,
                                      highlightbackground="black", font="none 18")

        self.variable = StringVar(self.myContainer1)
        self.variable.set("5")  # default value
        self.drop_down = OptionMenu(self.myContainer1, self.variable, "2", "5", "10", "15", "20", command=self.update_rot_speed)
        ...
        self.angle_scale = Scale(self.myContainer1, label='Start angle', from_=0, to=360, orient=tk.HORIZONTAL, length=200,bg='black', activebackground=HOVERCOLER, borderwidth=0,
                                      highlightbackground="black", font="none 12", fg= "white", showvalue=1,tickinterval=60, resolution=1, command=self.update_start_angle) #
        self.angle_scale.set(330)

        self.angle_scale2 = Scale(self.myContainer1, label='Stop angle', from_=0, to=360, orient=tk.HORIZONTAL, length=200,bg='black', activebackground=HOVERCOLER, borderwidth=0,
                                      highlightbackground="black", font="none 12", fg= "white", showvalue=1,tickinterval=60, resolution=1, command=self.update_stop_angle) #
        self.angle_scale2.set(30)

        self.angle_scale3 = Scale(self.myContainer1, label='Slider rotation speed', from_=0, to=200, orient=tk.HORIZONTAL, length=200,bg='black', activebackground=HOVERCOLER, borderwidth=0,
                                      highlightbackground="black", font="none 12", fg= "white", showvalue=1,tickinterval=50, resolution=1, command=self.update_rot_speed) #
        self.angle_scale3.set(5)

        self.angle_scale4 = Scale(self.myContainer1, label='Slider speed', from_=0, to=200, orient=tk.HORIZONTAL, length=200,bg='black', activebackground=HOVERCOLER, borderwidth=0,
                                      highlightbackground="black", font="none 12", fg= "white", showvalue=1,tickinterval=50, resolution=1, command=self.update_speed) #
        self.angle_scale4.set(50)

        self.angle_scale5 = Scale(self.myContainer1, label='Table speed', from_=0, to=200, orient=tk.HORIZONTAL, length=200,bg='black', activebackground=HOVERCOLER, borderwidth=0,
                                      highlightbackground="black", font="none 12", fg= "white", showvalue=1,tickinterval=50, resolution=1, command=self.update_table_speed) #
        self.angle_scale5.set(50)

        # Organize layout using grid
        self.angle_scale.place(x=520, y=230, anchor="s", height=200, width=300)
        self.angle_scale2.place(x=520, y=330, anchor="s", height=200, width=300)
        self.angle_scale3.place(x=520, y=430, anchor="s", height=200, width=300)
        self.angle_scale4.place(x=520, y=530, anchor="s", height=200, width=300)

        self.angle_scale5.place(x=160, y=110, anchor="s", height=80, width=300)
        # self.label.place(x=520, y=440, anchor="s", height=430, width=500)
        self.rotate_img.place(x=140, y=200, anchor="s", height=80, width=240)
        self.load_img.place(x=140, y=370, anchor="s", height=80, width=240)
        ...
        self.burn.place(x=140, y=455, anchor="s", height=80, width=240)
    ...
    def update_table_speed(self, par):
        """Updates angle
        Variables:
        ...
        address, data = uv_from_CAN(fromAddress=1, toAddress=2, respondMessage=1, get_val=34, command=3,
                                    uf_nr=1, sub_command=34, data=int(self.angle_scale5.get()))
    ...
    def update_rot_speed(self, par):
        ...
        address, data = uv_from_CAN(fromAddress=1, toAddress=2, respondMessage=1, get_val=30, command=3,
                                    uf_nr=1, sub_command=30, data=int(self.angle_scale3.get()))
    ...
    def update_speed(self, par):
        ...
        """
        address, data = uv_from_CAN(fromAddress=1, toAddress=2, respondMessage=1, get_val=33, command=3,
                                    uf_nr=1, sub_command=33, data=int(self.angle_scale4.get()))
    ...
    def update_start_angle(self, par):
        """Updates angle
        Variables:
        userFunctionVariable1 = 30      158
        userFunctionVariable2 = 31      159
        ...
        """
        print("angle start" + str(self.angle_scale.get()))
        self._start_angle = int(self.angle_scale.get())

        address, data = uv_from_CAN(fromAddress=1, toAddress=2, respondMessage=1, get_val=31, command=3,
                                    uf_nr=1, sub_command=31, data=self._start_angle)
    ...
    def update_stop_angle(self, par):
        """Updates angle
        """
        print("angle stop " + str(self.angle_scale2.get()))
        self._stop_angle = int(self.angle_scale2.get())

        address, data = uv_from_CAN(fromAddress=1, toAddress=2, respondMessage=1, get_val=32, command=3,
                                    uf_nr=1, sub_command=32, data=self._stop_angle)
    ...
    def start_table(self):
        ...
        address, data = uf_to_CAN(fromAddress=1, toAddress=2, respondMessage=1, usr_fnct_id=1,
                                      command="f", sub_command="s", uf_nr=1, par=5)
        if not PC:
            # Send CAN message
            self.send_CAN(address, data)
    ...
    def set_start_pos(self):
        """Starts printing
        """
        self.update_rot_speed(par=0)
        print("update rot speed : " + str(int(self.angle_scale3.get())))
        time.sleep(0.1)

        self.update_speed(par=0)
        print("update speed : " + str(int(self.angle_scale4.get())))
        time.sleep(0.1)

        self.update_start_angle(par=0)
        print("update start angle: " + str(int(self.angle_scale.get())))
        time.sleep(0.1)

        self.update_stop_angle(par=0)
        print("update stop angle : " + str(int(self.angle_scale2.get())))
        time.sleep(0.1)

        address, data = uf_to_CAN(fromAddress=1, toAddress=2, respondMessage=1, usr_fnct_id=1,
                                      command="f", sub_command="s", uf_nr=1, par=3)
        if not PC:
                # Send CAN message
            self.send_CAN(address, data)

    def tc_reboot_monsterrhino(self):
        """
        reboots the monsterrhino cards
        :return:
        """
        # Transform CAN command
        address, data = sys_to_CAN(toAddress = 0, command="s", sub_command="sytemReboot", fromAddress=1, data=0, usr_fnct_id=0, respondMessage = 1)
        # Send CAN message
        self.send_CAN(address, data)
        # self.logger.info("Monsterrhino reboot!")
        print("Monsterrhino reboot!")
    ...
    def pen_up(self):
        pen_pos = 60
        _steps = pen_pos * 1000
        address, data = cmd_to_CAN(command="m", sub_command="tp", motor_nr=3,
    ...
    def y_move_targetposition(self, pos=700):
        ...
        """
        _steps = pos * 1000
        address, data = cmd_to_CAN(command="m", sub_command="tp", motor_nr=4,
                                   usr_fnct_id=1, err=0, data=_steps, toAddress=2,
                                   fromAddress=1, respondMessage=1)
        if not PC:
            # Send CAN message
    ...
    def home_xy_axis(self):
        ...
        """
        # self.tc_reboot_monsterrhino()
        # time.sleep(3)


        address, data = uf_to_CAN(fromAddress=1, toAddress=2, respondMessage=1, usr_fnct_id=1,
                                  command="f", sub_command="s", uf_nr=1, par=1)
        if not PC:
            # Send CAN message
            self.send_CAN(address, data)
    ...
    # def set_start_pos(self):
    #     """Set rotational start position
    #     """
    #     # self.update_stop_angle()
    #     # time.sleep(0.1)
    #     # self.update_start_angle()
    #     # time.sleep(0.1)
    #     # self.update_speed()
    #     # time.sleep(0.1)
    #     # self.update_rot_speed()
    #     # time.sleep(0.1)
    #
    #
    #     address, data = uf_to_CAN(fromAddress=1, toAddress=2, respondMessage=1, usr_fnct_id=1,
    ...
    def image_resize(self, image, width=None, height=None):
        ...
        # resize the image
        resized = None#cv2.resize(image, dim, interpolation=inter)
                    ...
                    if positive:
                        ...
                        for idx, pix in enumerate(reversed(img[:, c])):
                            ...
                            if pix == prev_pix:
                                ...
                                print("Pen up - move to idx: {}!".format(idx))
                                if not PC:
                                    self.pen_up()
                                ...
                                # draw color is white
                                print((len(img[:, c]) - idx), pix)
                                print("Pen down - move to idx: {}!".format(idx))
                                if not PC:
                                    self.pen_down()
                                    # time.sleep(wait_for_pen)
                                    self.wait_to_finish()
                        ...
                        for idx, pix in enumerate(img[:, c]):
                            ...
                            if pix == prev_pix:
                                ...
                                # draw color is black
                                print((len(img[:, c]) - idx), pix)
                                print("Pen up - move to idx: {}!".format((len(img[:, c]) - idx)))
                                if not PC:
                                    self.pen_up()
                                    # time.sleep(wait_for_pen)
                                    self.wait_to_finish()
                                ...
                                # draw color is white
                                print((len(img[:, c]) - idx), pix)
                                print("Pen down - move to idx: {}!".format((len(img[:, c]) - idx)))
                                if not PC:
                                    self.pen_down()
                                    # time.sleep(wait_for_pen)
                                    self.wait_to_finish()
